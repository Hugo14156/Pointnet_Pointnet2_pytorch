"""
Author: Hugo Delasnerie
Date: August 2024
"""

import argparse
import os
from data_utils.VoyantDataLoader import VoyantDataset
import torch
import datetime
import logging
...
def main(args):
    ...
    root = "/home/labuser/workspace/repos/Voyant-NeuralNet/data/Warehouse"
    NUM_CLASSES = len(classes)
    NUM_POINT = args.npoint
    BATCH_SIZE = args.batch_size

    print("start loading training data ...")
    TRAIN_DATASET = VoyantDataset(
        split="train",
        classes=classes,
        data_root=root,
        num_point=NUM_POINT,
